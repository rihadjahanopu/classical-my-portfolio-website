		...
		<>
			...
			<main
							...
							<img
								...
								onClick={() =>
									(window.location.href =
										"https://linkedin.com/in/rihadjahanopu")
								}
							/>
							<img
				...
				<section
					...
					<h2 className="text-5xl text-center font-bold mb-10 title">
						About Me
					</h2>
					<div className="flex flex-col gap-12">
						<div className="flex flex-col xl:flex-row gap-16 items-center justify-center">
							<div className="w-full xl:w-[400px] h-[400px] rounded-3xl overflow-hidden shadow-2xl flex-shrink-0 about-image-co">
								<img
							...
							<div className="flex-1 text-justify text-gray-600 text-lg leading-relaxed break-words">
								<p>
									...
									specialize in creating secure, scalable, and high-performance
									web and mobile applications tailored to meet your unique
									business requirements. With a strong command of both front-end
									and back-end technologies, I deliver seamless user experiences
									and robust functionalities. Whether it’s a dynamic website, a
									powerful API, or a feature-rich cross-platform mobile app, I’m
									passionate about bringing your vision to life with precision,
									innovation, and creativity. Let’s work together to build
				...
				<motion.section
					...
					<div className="flex flex-col md:flex-row justify-center items-center gap-6 w-full max-w-4xl mx-auto px-4">
						<motion.div
							...
							onClick={() =>
								(window.location.href = "mailto:itrihad@gmail.com")
							}>
